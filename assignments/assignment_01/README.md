...
mkdir ./assignment_01/data/clean
mkdir ./assignment_01/scripts
mkdir ./assignment_01/results
mkdir ./assignment_01/docs
mkdir ./assignment_01/config
mkdir ./assignment_01/logs
```
